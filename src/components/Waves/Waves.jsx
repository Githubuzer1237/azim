...
export default function Waves({
  ...
  return (
    <div
      ...
      style={{
        position: "relative",
        top: 200, left: 0, margin: 0, padding: 0,
        width: "100%", height: "80dvh", overflow: "hidden",
        backgroundColor: "#000",
        ...style
      }}
    >
      <div style={{
        ...
        <h1 className="h1__title">Курсы по программированию</h1>
        <div style={{  display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'     }}>
           <Link to={'/courses'} className="curslink" > → Перейти к курсам</Link>
            </div>
      </div>
      <canvas ref={canvasRef} style={{ display: "block", width: "100%", height: "80dvh" }} />
    </div>
  );
}
